											...
											<HelpOutlineIcon
												...
												onMouseEnter={(e) =>
													setpop1({
														...
														text: (
															<div>
																The web page to direct people to when they click your
																ad. Make sure the landing page:
																<ul>
																	<li>
																	...
																	<li>
																		...
																		even if your campaign targets a specific country
																		or region.
																	</li>
																</ul>
															</div>
